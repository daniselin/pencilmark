...
const PuzzleSearch = (props) => {
    ...
    return(
        isLoading ? <Loading/> :
            <MainContainer section="puzzle-search"
                           title={<h1>Puzzle Search</h1>}>}>
            </MainContainer>
    );
};

export default connect(mapStateToProps, mapDispatchToProps)(PuzzleSearch);