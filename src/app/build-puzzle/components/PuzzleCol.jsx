...
const mapDispatchToProps = (dispatch) => {
    return {
        actions: bindActionCreators({
            ...
            controlClickCell: buildPuzzleActions.controlClickCell,
            dragCell: buildPuzzleActions.dragCell,
            controlDragCell: buildPuzzleActions.controlDragCell,
            initializeDragCell: buildPuzzleActions.initializeCellDrag,
            initializeControlDragCell: buildPuzzleActions.initializeControlCellDrag,
